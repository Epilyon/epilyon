...
class _ManagePageState extends State<ManagePage> {
  ...
  void removeDelegateDialog(Delegate delegate) {
    showConfirmDialog(context,
        ...
        content:
            "Voulez-vous vraiment enlever '${delegate.name}' des délégués ?",
  ...
  void notifyAllDialog() {
    showConfirmDialog(context,
        ...
        content:
            "Voulez vous envoyer à TOUTE LA PROMO une notification avec comme "
  ...
  void doRemoveDelegate(Delegate delegate) {
    removeDelegate(delegate.email).then((_) {
      ...
      showErrorDialog(this.context,
          title: 'Erreur',
          content:
              "Impossible de supprimer le délégué  '${delegate.name}'\n$err");
    });
  }
    ...
    return Center(
      ...
      children: <Widget>[
        ...
        Text(
          isUserAdmin()
              ? 'Administrateur'
              : (isUserClassRep() ? 'Délégué' : 'Rien du tout'),
          style: TextStyle(
              fontSize: 36.0,
        ...
        Padding(
          padding:
              EdgeInsets.only(top: 2.5, bottom: !isUserAdmin() ? 10.0 : 35.0),
          child: Text('de la promo ' + user.promo,
        ...
        isUserAdmin()
            ? Padding(
                padding: const EdgeInsets.only(
                    top: 30.0, left: 65.0, right: 65.0, bottom: 10.0),
                child: EpiButton(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child:
                        EpiButton(text: 'Envoyer', onPressed: notifyAllDialog),
                  )
                ],
              )),
        )
